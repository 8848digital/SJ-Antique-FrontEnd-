...
const ItemWiseReportApi = async (get_access_token: any, params: any) => {
  let response: any;
  ...
  let url: any = '/api/method/sj_antique.sdk.api?version=v1&method=get_item_wise_report&entity=report&';
...
export default ItemWiseReportApi;

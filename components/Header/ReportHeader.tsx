...
const ReportHeader = () => {
  ...
  return (
    <div className="d-flex justify-content-center flex-wrap">
      ...
      >
        <button
          className={`${styles.button} ${styled.report_header_btn} ${query?.reportId === 'item-wise-report' ? 'activeColor' : ''
            }`}
        >
          Item Report
          <i className="fa-solid fa-arrow-turn-down mx-2 pt-1"></i>
      ...
      >
        <button
          className={`${styles.button} ${styled.report_header_btn} ${query?.reportId === 'ready-stock-summary-report' ? 'activeColor' : ''
            }`}
        >

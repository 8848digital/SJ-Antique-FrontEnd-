...
const FilterKundanReadyReceiptListing = ({ HandleSearchInput, receiptNoList, setSearchReceiptNumber, searchReceiptNumber, searchInputValues }: any) => {
            ...
            <div className="row justify-content-center ">
                <div className="col-md-2 ">
                    ...
                    {/* <SelectInputKunKarigar
                        kundanKarigarData={receiptNoList}
                        placeholderValue="Receipt no"
                        tableData={searchReceiptNumber}
                        setTableData={setSearchReceiptNumber}
                    /> */}
                </div>
